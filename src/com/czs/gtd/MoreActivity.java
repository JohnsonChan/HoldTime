...
public class MoreActivity extends Activity implements UpdatePointsNotifier
{
...
//        isBlock = AppConnect.getInstance(GTDConstants.WAPS_ID, GTDConstants.WAPS_PID,this).getConfig("isBlock", "false");
        ...
        extendCornerListView.setOnItemClickListener(new OnItemClickListener()
        {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3)
            {
                switch (arg2)
                {
                    ...
                    break;
                    case 2: // �����
                        AppConnect.getInstance(GTDConstants.WAPS_ID, GTDConstants.WAPS_PID,MoreActivity.this).showFeedback();
                    break;
                    case 3: // ������
                        AppConnect.getInstance(GTDConstants.WAPS_ID, GTDConstants.WAPS_PID,MoreActivity.this).checkUpdate(MoreActivity.this);
                    break;
                }
            }
        });
    ...
    protected void onStart()
    {
        ...
        {
            isShare = false;
            AppConnect.getInstance(GTDConstants.WAPS_ID, GTDConstants.WAPS_PID,MoreActivity.this).awardPoints(GTDConstants.SHARE_SCORE, this);
        }
        super.onStart();
    }
